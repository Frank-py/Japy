...
public class messenger_interface {
    ...
    void initialize() {
        ...
        addUsers.setFont(new Font(std_font_type, Font.BOLD, 20));
        ...
        // creating Users Sidebar
        Users = new JPanel();
        Users.setLayout(new GridLayout(11, 1));
        Users.setBackground(colortheme);
        Users.setBackground(Color.green); // DEBUG
        // both needed so it appears and has right size
        Users.setPreferredSize(new Dimension(frame.getWidth() / 10 * 3,frame.getHeight()));
        Users.setSize(new Dimension(frame.getWidth() / 10 * 3, frame.getHeight()));
        Users.add(addUsers);
        ...
        Useruser.setFont(new Font("std_font_type", Font.PLAIN, 35));
       ...
       // back.setOpaque(false);
        ...
        // back.setPreferredSize(new Dimension(frame.getWidth() - Users.getWidth(),z
        
        // frame.getHeight()));// needed?
